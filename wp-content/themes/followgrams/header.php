				...
				<div class="col span_9 col_last">
					...
					<nav>
						<ul class="sf-menu">	
							...
							?>
							<?php /* <li id="search-btn"><div><a href=""><span class="icon-salient-search" aria-hidden="true"></span></a></div></li> */ ?>
						</ul>
					</nav>
...
<script type="text/javascript">
	jQuery(function(){
		var height=jQuery(window).height()-144;
		
			jQuery('.container-wrap').css('min-height',height);
